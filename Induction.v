...
Proof.
  intros n. induction n as [| n'].
  simpl. reflexivity. simpl. rewrite -> IHn'. reflexivity.
Qed.
...
destruct gives subgoals for discrete possibilities, 
like for booleans, true and false.

induction is useful when there are potentially infinite possibilites
and you want to break it into 0, n, and n'.  If you prove it works on n
and n+1 then it should work for all n *)
...
Theorem mult_plus_one : forall a b : nat,
  a + (a * b) = a * (b + 1).
Proof.
